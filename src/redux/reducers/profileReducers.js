...
export const profileGetMyProfileReducer = (state = {}, action) => {
  switch (action.type) {
    case PROFILE_GET_MY_PROFILE_REQUEST:
      return { loading: true };
    case PROFILE_GET_MY_PROFILE_SUCCESS:
      return { loading: false, profile: action.payload };
    case PROFILE_GET_MY_PROFILE_FAIL:
...
export const profileUpdateInfoReducer = (state = { profile: null }, action) => {
  switch (action.type) {
    case PROFILE_UPDATE_INFO_REQUEST:
      return { loading: true };
    case PROFILE_UPDATE_INFO_SUCCESS:
      return { loading: false, profile: action.payload };
    case PROFILE_UPDATE_INFO_FAIL:
      return { loading: false, error: action.payload };
    case PROFILE_UPDATE_INFO_RESET:
      return { profile: null };
    default:
      return state;
  }
