...
export default function Modal({ show, onClose, title, children }) {
  ...
  const modalContent = show ? (
    <div className='fixed top-0 z-20 flex items-center justify-center w-full h-full overflow-hidden bg-black bg-opacity-40 '>
      <div className='animate-fadeIn flex flex-col justify-between w-11/12 bg-gray-700 border-2 border-orange-600 rounded-md lg:w-8/12 overflow-y-scoll scollbar-thin max-h-8/10'>
